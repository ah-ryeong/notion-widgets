...
var tickSound = new Howl({
		src: ['https://reneroth.xyz/files/codepen/pomodoro_tick.ogg', 'https://reneroth.xyz/files/codepen/pomodoro_tick.mp3'],
		loop: true,
		volume: 0.5
});
var turnSound = new Howl({
		src: ['https://reneroth.xyz/files/codepen/pomodoro_turn.ogg', 'https://reneroth.xyz/files/codepen/pomodoro_turn.mp3']
});
var isTickPlaying = false;
var turnSoundDist = 25 / 2;
var ringSound = new Howl({
		src: ['https://reneroth.xyz/files/codepen/pomodoro_ring.ogg', 'https://reneroth.xyz/files/codepen/pomodoro_ring.mp3'],
		volume: 1.0
});
